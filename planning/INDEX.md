...
## Active plan
- feat/sc2egset-02-01-02-pre-game-materialization-scaffold (2026-05-23) — Category A: Layer-2 scaffold + ONE validation module for SC2EGSet Step 02_01_02 (5 pre_game families; ChatGPT second-pass MMR-missingness allowlist + boundary-aware token-equality correction included). NO feature value materialized, NO artifact, NO status YAML flip, NO research_log, NO ROADMAP edit, NO Phase 03. Version bump 3.67.0 → 3.68.0 (PR #233, draft).
