...
| §2.2 StarCraft II | thesis/chapters/02_theoretical_background.md | 2026-04-17 | 4 [REVIEW] | thesis/references.bib (4 new entries: Liquipedia_GameSpeed, BlizzardS2Protocol, Wikipedia_SC2Esports, Liquipedia_ESLProTour); src/rts_predict/games/sc2/datasets/sc2egset/reports/research_log.md (Phase 01 findings 01_03_01–01_04_00) | Pending — Pass 1 calibration draft. 14 distinct keys cited. Polish ~14.5k chars. Key Pass 2 questions: (1) align grey-literature acceptability for Liquipedia_GameSpeed and BlizzardS2Protocol with §2.5.4 Battle.net MMR decision; (2) reconcile minor PlayerStats period rounding (160 game loops ≈ 7.14s) vs research_log "10s at Faster"; (3) inherit §2.5.4 Aligulac calibration (~80%) flag for narrative consistency; (4) confirm UAlbertaBot Replay Dataset reference inclusion (mentioned without bib entry). |
| §2.3 Age of Empires II | thesis/chapters/02_theoretical_background.md | 2026-04-17 | 5 [REVIEW] | src/rts_predict/games/aoe2/datasets/aoestats/reports/research_log.md (17.8M matches, 107.6M player-history rows); src/rts_predict/games/aoe2/datasets/aoe2companion/reports/research_log.md (30.5M matches, 61.0M player-rows, 264.1M player-history rows); thesis/references.bib (6 new entries: AoE2DE, MgzParser, AoEStats, AoeCompanion, AoE2MapPool, RedBullWololoLondinium) | Pending — Pass 1 calibration draft (mixed Literature + Data-fed). 10 distinct keys cited. Polish ~13.8k chars. Key Pass 2 questions: (1) verify exact civilization count for the 2024–2026 corpus window; (2) verify K-factor for AoE2 DE 1v1 Random Map ladder (Tang2025 cites K=32 vs community variable K); (3) verify map pool snapshot representativeness for corpus window; (4) confirm peer-reviewed source for Feudal/Castle age timing; (5) verify Liquipedia + GitHub URLs grey-literature acceptability per PJAIT thesis guidelines. |
