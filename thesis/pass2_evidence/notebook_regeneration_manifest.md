...
| Notebook path | Step | Artifact status | Thesis claim(s) | Regen status | Cause |
|--------------|------|----------------|-----------------|-------------|-------|
| `sandbox/sc2/sc2egset/02_feature_engineering/01_pre_game_vs_in_game_boundary/02_01_01_feature_family_registry_skeleton.py` | 02_01_01 | provisional registry artifact emitted; validated_through=V-9; CSV+MD present; no Step closure | Chapter 4 §4.5 feature-engineering registry / Phase 02 registry baseline; provisional only | `partial_coverage_v9_baseline` | PR #216 provisional artifact baseline / non-closure lineage |
