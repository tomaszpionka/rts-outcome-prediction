...
- **Web-depth budget (user decision 2026-05-17, up to 3 formulations for new Ch1/Ch2 loci).** No new Chapter 1/2 literature locus required fresh web verification: GarciaMendez2025, Vinyals2017, Demsar2006, Thorrez2024/EsportsBench, Hodge2021, Lin2024NCT, Hamilton2025, Tang2025, CetinTas2023, Elbert2025EC are all already in `literature_verification_log.md` with recorded URLs (these are cited in Ch1/Ch2 as well as Ch3). The grey-lit infrastructure citations (Aligulac, Liquipedia_GameSpeed, BlizzardS2Protocol, AoE2DE) are flagged grey-lit in the chapter and routed `ok_to_send_with_flag`. The web budget was therefore not consumed; this is recorded honestly rather than claimed as additional verification.
