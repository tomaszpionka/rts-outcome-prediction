...
| Section | Status | Feeds from | Notes |
|---------|--------|------------|-------|
| §2.1 Gry strategiczne czasu rzeczywistego | `DRAFTED` | — | Literature; Pass 1 calibration draft (2026-04-17). 9 distinct keys, 1 [REVIEW] flag. ~12.0k chars Polish. 1 new bibtex entry (Buro2003). |
| §2.2 StarCraft II | `DRAFTED` | Phase 01 (Data Exploration — timing, mechanics, corpus characteristics) | Mixed Literature + Data-fed; Pass 1 calibration draft (2026-04-17). 14 distinct keys, 4 [REVIEW] flags (3 grey-literature acceptability, 1 corpus-numeric cross-check). ~14.5k chars Polish. 4 new bibtex entries (Liquipedia_GameSpeed, BlizzardS2Protocol, Wikipedia_SC2Esports, Liquipedia_ESLProTour). Cites research_log Phase 01 findings 01_03_01–01_04_00. |
| §2.3 Age of Empires II | `DRAFTED` | Phase 01 (aoestats + aoe2companion data exploration) | Mixed Literature + Data-fed; Pass 1 calibration draft (2026-04-17; user-overrode prior BLOCKED status — both AoE2 datasets completed Phase 01 by Sprints 1-3 of night session). 10 distinct keys, 5 [REVIEW] flags. ~13.8k chars Polish. 6 new bibtex entries (AoE2DE, MgzParser, AoEStats, AoeCompanion, AoE2MapPool, RedBullWololoLondinium). Cites Phase 01 corpus numbers (17.8M aoestats / 30.5M aoe2companion). |
